...
import { threeCard, readingPageChrome } from "@/content/reading-pages";
          ...
          <div className="grid gap-y-[clamp(2rem,4.17vw,5rem)] lg:grid-cols-2 lg:items-start lg:gap-x-[min(3.021vw,3.625rem)]">
            ...
            */}
            <ReadingPanel moon bodyClassName="reading-panel-sky px-[4.44cqw] pt-[11.35cqw] pb-[8.59cqw]">
              <ReadingHero reading={threeCard} />
              <ReadingOrder reading={threeCard} />
            </ReadingPanel>
            ...
            */}
            ...
            >
              <WhatYouGet reading={threeCard} />
              <BeyondTheGate />
              <ReadingTestimonial reading={threeCard} />
            </ReadingPanel>
          </div>
        </Container>
      </Section>
