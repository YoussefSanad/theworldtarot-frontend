...
You can also customise Checkout and access additional functionality with [Checkout Sessions](https://docs.stripe.com/api/checkout/sessions.md) and the Stripe Dashboard. For a complete list of features, see its [built-in and customisable features](https://docs.stripe.com/payments/checkout/how-checkout-works.md#features).
...
4. After the transaction, a *webhook* (A webhook is a real-time push notification sent to your application as a JSON payload through HTTPS requests) [fulfils the order](https://docs.stripe.com/checkout/fulfillment.md) using the [checkout.session.completed](https://docs.stripe.com/api/events/types.md#event_types-checkout.session.completed) event.
...
| [Managed Payments](https://docs.stripe.com/payments/managed-payments/how-it-works.md)                         | Customisable |
| [Collect taxes](https://docs.stripe.com/payments/checkout/taxes.md)                                           | Customisable |
| [Custom branding with colours, buttons, and font](https://docs.stripe.com/payments/checkout/customization.md) | Customisable |
| [Optional items](https://docs.stripe.com/payments/checkout/optional-items.md)                                 | Customisable |
| [Global payment methods](https://docs.stripe.com/payments/dashboard-payment-methods.md)                       | Customisable |
| [Subscription upsells](https://docs.stripe.com/payments/checkout/upsells.md)                                  | Customisable |
| [Custom domains](https://docs.stripe.com/payments/checkout/custom-domains.md) (Full hosted page only)         | Customisable |
| [Email receipts](https://docs.stripe.com/receipts.md)                                                         | Customisable |
| [Apply discounts](https://docs.stripe.com/payments/checkout/discounts.md)                                     | Customisable |
| [Custom success page](https://docs.stripe.com/payments/checkout/custom-success-page.md)                       | Customisable |
| [Recover abandoned carts](https://docs.stripe.com/payments/checkout/abandoned-carts.md)                       | Customisable |
| [Autofill payment details with Link](https://docs.stripe.com/payments/link/checkout-link.md)                  | Customisable |
| [Collect Tax IDs](https://docs.stripe.com/tax/checkout/tax-ids.md)                                            | Customisable |
| [Collect shipping information](https://docs.stripe.com/payments/collect-addresses.md?payment-ui=checkout)     | Customisable |
| [Collect phone numbers](https://docs.stripe.com/payments/checkout/phone-numbers.md)                           | Customisable |
| [Set the subscription billing cycle date](https://docs.stripe.com/payments/checkout/billing-cycle.md)         | Customisable |

### Custom branding

You can set fonts, colours, icons, and field styles for your Stripe-hosted Checkout page using the [Branding settings](https://dashboard.stripe.com/settings/branding/checkout) in the Dashboard. For more information, see [Customise your integration](https://docs.stripe.com/payments/checkout/customization.md).
...
You can set a custom expiry time for a `Checkout Session` by setting the [expires_at](https://docs.stripe.com/api/checkout/sessions/create.md#create_checkout_session-expires_at) parameter. It can be anywhere from 30 minutes to 24 hours after `Checkout Session` creation.
...
- Process the [checkout.session.completed](https://docs.stripe.com/api/events/types.md#event_types-checkout.session.completed) event to fulfil orders when a customer completes their purchase.
...
Stripe Checkout pages have a structure and labelled controls to help customers complete checkout, and to help automated agents understand and navigate checkout pages. They also accommodate customers who might have accessibility needs, such as those who use screen readers.
...
- [Fulfil your orders](https://docs.stripe.com/checkout/fulfillment.md)
